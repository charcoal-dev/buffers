...
/**
 * Type for a 16-byte (Immutable and Fixed-Length) buffer.
 */
final readonly class Bytes16 extends FixedLengthImmutableBuffer
{
    protected const int FixedLengthBytes = 16;
}